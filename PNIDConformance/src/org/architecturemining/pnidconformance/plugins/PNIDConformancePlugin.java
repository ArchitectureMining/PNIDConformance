...
public class PNIDConformancePlugin {
	...
	public Object MineTS(PluginContext context, MarkedPetriNet pnid, XLog trace) throws IOException {
		return RunPNIDConformance.mineTSFromPNIDAndTrace(context, pnid, trace);
	}
}
